...
resource 'DITL' (130, "About Geomys") {
	{
		...
		/* 3: App name + version */
		{10, 55, 30, 280},
		StaticText { disabled, "Geomys 0.12.0" };
...
data 'cicn' (272, "Home") {
	...
	$"0000 0180 03C0 07E0 0FF0 1FF8 3FFC 0FF0 0FF0 0FF0 0FF0 0E70 0E70 0000 0000 0000"
	$"00000000 0000 0001 0000 FFFF FFFF FFFF 0001 8888 4444 0000"
	$"0000 0180 03C0 07E0 0FF0 1FF8 3FFC 0FF0 0FF0 0FF0 0FF0 0E70 0E70 0000 0000 0000"
};
...
resource 'vers' (1) {
	0x00, 0x0C, release, 0x00, verUS,
	"0.12.0",
	"Geomys 0.12.0 \0xA9 2025\0x962026"
};
